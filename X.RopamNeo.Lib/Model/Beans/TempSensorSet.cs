// Type: X.RopamNeo.Lib.Model.Beans.TempSensorSet

using System.ComponentModel;

namespace X.RopamNeo.Lib.Model.Beans
{
    public class TempSensorSet : INotifyPropertyChanged
    {
        private int id;
        private int site;
        private bool wired0;
        ...
        public void CopyState(TempSensorSet set)
        {
        ...
        public TempSensorSet Clone() => new TempSensorSet()
        {
            Id = this.Id,
            Site = this.Site,
            Wired0 = this.Wired0,
